...
//                       if($this->homeLink===null)  $links[]=CHtml::link(Yii::t('zii','Home'),Yii::app()->createAbsoluteUrl('/bookingsystem/default/index'));
                       if($this->homeLink===null)  $links[]=CHtml::link('Home',Yii::app()->createAbsoluteUrl('/admin/default/index'));
